...
class LanguageZhHant extends Language {

  final _menu = _MenuZhHant();
  final _loginPage = _LoginPageZhHant();
  final _paymentPage = _PaymentPageZhHant();
  final _accountPage = _AccountPageZhHant();
  ...
  @override
  String get languageCode => languageHant;
...
class _MenuZhHant extends Menu {
  @override
...
class _LoginPageZhHant extends LoginPage {
  @override
...
class _PaymentPageZhHant extends PaymentPage {
...
class _AccountPageZhHant extends AccountPage {
  @override
